            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        if (!queue) {
                            return [2 /*return*/, interaction.editReply({ content: "There is no queue!" })];
                        }
                        return [4 /*yield*/, queue.tracks.clear()];
                    case 2:
                        _b.sent();
                        return [2 /*return*/, interaction.editReply({ content: "Queue cleared successfully!" })];
                    case 3:
                        error_1 = _b.sent();
                        console.log(error_1);
                        return [3 /*break*/, 4];

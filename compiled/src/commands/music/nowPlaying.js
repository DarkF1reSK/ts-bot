...
exports["default"] = {
    ...
    callback: function (_a) {
        ...
        return __awaiter(void 0, void 0, void 0, function () {
            var queue, progress, ts, embed, error_1;
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        if (!queue || !queue.isPlaying()) {
                            return [2 /*return*/, interaction.reply({ content: "There is not playing anything", ephemeral: true })];
                        }
                        progress = queue.node.createProgressBar();
                        ts = queue.node.getTimestamp();
                        embed = new discord_js_1.EmbedBuilder()
                            .setTitle("Now playing")
                            .setDescription("[".concat(queue.currentTrack.title, "](").concat(queue.currentTrack.url, ")"))
                            .setThumbnail("".concat(queue.currentTrack.thumbnail))

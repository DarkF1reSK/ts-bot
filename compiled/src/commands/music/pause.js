            ...
            return __generator(this, function (_b) {
                try {
                    ...
                    if (!queue || !queue.isPlaying()) {
                        return [2 /*return*/, interaction.reply({ content: "There is nothing playing", ephemeral: true })];
                    }
                    paused = queue.node.setPaused(true);
                    return [2 /*return*/, interaction.reply({ content: paused ? 'paused' : "something went wrong" })];
                }
                catch (error) {
                    console.log(error);
                }

    ...
    callback: function (_a) {
        ...
        return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                reqDir(path_1["default"].join(__dirname), "description");
                helpMessage = command
                    .filter(function (description) { return description !== undefined; })
                    .map(function (description) { return "\u2022 ".concat(description); })
                    .join("\n");
                if (helpMessage) {
